                    ...
                    <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                        <form action="{{ route('shifts.update', $shift) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" name="date" id="date" value="{{ old('date', $shift->date) }}"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="worker" id="worker" value="{{ old('worker', $shift->worker) }}"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="company" id="company"
                                       value="{{ old('company', $shift->company) }}"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="hours" id="hours" value="{{ old('hours', $shift->hours) }}"
                            ...
                            <div class="mb-4">
                                ...
                                <select name="taxable" id="taxable"
                                    ...
                                    <option value="1" {{ old('taxable', $shift->taxable) == 1 ? 'selected' : '' }}>Yes
                                    </option>
                                    <option value="0" {{ old('taxable', $shift->taxable) != 1 ? 'selected' : '' }}>No
                                    </option>
                                </select>
                                @error('taxable')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            ...
                            <div class="mb-4">
                                ...
                                <select name="status" id="status"
                                    ...
                                    <option
                                        value="Processing" {{ old('status', $shift->status) == 'Processing' ? 'selected' : '' }}>
                                        Processing
                                    </option>
                                    <option
                                        value="Pending" {{ old('status', $shift->status) == 'Pending' ? 'selected' : '' }}>
                                        Pending
                                    </option>
                                    <option
                                        value="Complete" {{ old('status', $shift->status) == 'Complete' ? 'selected' : '' }}>
                                        Complete
                                    </option>
                                    <option
                                        value="Failed" {{ old('status', $shift->status) == 'Failed' ? 'selected' : '' }}>
                                        Failed
                                    </option>
                                </select>
                                @error('status')
                            ...
                            <div class="mb-4">
                                ...
                                <select name="shift_type" id="shift_type"
                                    ...
                                    <option
                                        value="Day" {{ old('shift_type', $shift->shift_type) == 'Day' ? 'selected' : '' }}>
                                        Day
                                    </option>
                                    <option
                                        value="Night" {{ old('shift_type', $shift->shift_type) == 'Night' ? 'selected' : '' }}>
                                        Night
                                    </option>
                                </select>
                                @error('shift_type')
